...
export const metadata: Metadata = {
  ...
  description:
    "Learn how Display collects, uses, and safeguards your personal information. This policy covers data retention, wallet usage, third-party integrations, and your privacy rights.",
};
